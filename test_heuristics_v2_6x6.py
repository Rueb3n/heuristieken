...
########################
# random algoritme maken (al gedaan volgens mij) als basecase
# belangrijk, aantal stappen weergeven per algoritme. tijd, stappen en iteraties meenemen.
# aantal boards vinden
# dict parent:child
# vraag van de child de parent
# 83 stappen is makkelijkste oplossing
# als niet admissible, geen a* noemen dus!!! -> het is gebaseerd op a*
# 9x9 1e draaien
########################
# code opschonen, commenten en functies individueel scheiden in meerdere files, aanroepen vanaf main en dan meerdere functies
# pep8 bekijken
# commment bij elke functie wat het doet
# bord 5 is lastig, 4 en 6 beter te doen met beam search

# github code plaatsen!!!!
		...
		for key, value in vehicle_dict.iteritems():
			...
			while movelist:
					...
					if not child_df_grid in archive:
						...
						check_goal(node[1], new_vehicle_dict, solution, df_grid, child_df_grid) #key error: 'r'
